...
const ReleaseUrl = "https://github.com/NothingAroundUs/voicecord/releases/download/v0.05-beta/latest.json"
const ReleaseUrlFallback = "https://github.com/NothingAroundUs/voicecord/releases/download/v0.05-beta/latest.json"
